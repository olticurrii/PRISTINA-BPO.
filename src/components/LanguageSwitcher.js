...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="w-5 h-5 rounded-full overflow-hidden flex items-center justify-center text-lg">
          {language === 'en' ? (
            <span>🇺🇸</span>
          ) : (
            <span>🇦🇱</span>
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-neutral-200 z-20">
            <div className="py-1">
              ...
              >
                <div className="w-4 h-4 rounded-full flex items-center justify-center text-lg">
                  🇺🇸
                </div>
